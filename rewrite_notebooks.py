...
nb04_cells = [
    ...
    {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
        ...
        "])\n",
        "\n",
        "# Grid optimizado: más valores de k, minkowski con distintos p\n",
        "param_grid = {\n",
        ...
        "}\n",
        "\n",
        "print('Iniciando Grid Search kNN optimizado...')\n",
        "grid_knn = GridSearchCV(pipeline_knn, param_grid, cv=5, n_jobs=-1, verbose=1, scoring='f1_macro')\n",
    ...
    {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
        ...
        "plot_confusion_matrix(cm, class_names, title='Matriz de Confusión — kNN (Optimizado)')\n",
    ]},
    {"cell_type":"code","execution_count":None,"metadata":{},"outputs":[],"source":[
